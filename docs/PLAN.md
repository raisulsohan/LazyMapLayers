...
| 9 — Polish and 1.0 | IN PROGRESS 2026-09-23: a once-a-day check of the release list with a switch to turn it off, and a problem report the user pastes into a new issue (D56, U1). A second sample, a data map of every country by population from the bundled data (U1). Left: translations (Bengali first), a fuller guide, performance budgets |
