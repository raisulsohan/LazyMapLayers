...
| 9 — Polish and 1.0 | IN PROGRESS 2026-09-23: a once-a-day check of the release list with a switch to turn it off, and a problem report the user pastes into a new issue (D56, U1). Left: translations (Bengali first), sample projects and a fuller guide, performance budgets |
