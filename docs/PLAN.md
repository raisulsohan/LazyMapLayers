...
| 7 — Map styles | IN PROGRESS 2026-09-22: a look of the designer's own - sea, land, lines and names, with everything else derived and the names kept readable - and a look taken from the palette of a picture (D42, LK1, U1). Left: more bundled looks, saving and sharing a look as a file, .ase palettes |
