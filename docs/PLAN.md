...
| 7 — Map styles | IN PROGRESS 2026-09-22: a look of the designer's own - sea, land, lines and names, with everything else derived and the names kept readable - and a look taken from the palette of a picture (D42, LK1, U1). A look saved to a file and opened again, and Illustrator or Photoshop palettes (.ase, .act) read straight into a look (D43). Left: more bundled looks, a style editor for the smaller details (road widths, label density) |
