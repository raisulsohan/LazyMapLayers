...
export type Look = { theme: ThemeLike; relief: boolean; highlights?: Highlight[]; areas?: Areas; data?: DataFill | null; heat?: HeatSetting | null; sky?: boolean; terrain?: TerrainSetting | null };
...
export function previewStyle(source: BasemapSource, projection: MapProjection, look: Look = { theme: null, relief: false }): StyleSpecification {
  ...
  const style = scaleStyleSizes(basemapStyle(usable, { labels: true, projection, viewport: comp, theme: look.theme, relief: look.relief, highlights: look.highlights, areas: look.areas, data: look.data, heat: look.heat, countryHits: true, sky: look.sky, terrain: look.terrain }), sizeFactor(), (layer) => layer.metadata?.["lml:group"] === "highlight");
